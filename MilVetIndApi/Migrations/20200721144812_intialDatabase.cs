    ...
    public partial class intialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PK_StoreSales = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FK_Store = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreSales", x => x.PK_StoreSales);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PK_StoreSalesItem = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreSalesItem", x => x.PK_StoreSalesItem);
                });
